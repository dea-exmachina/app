/**
 * CREEP Event Normalization & Validation Utilities
 *
...
import type { CreepEventCreate } from '@/types/creep'
...
export interface EventValidationResult {
  ...
  event?: CreepEventCreate
}

/**
 * Validates and normalizes a raw event input into a CreepEventCreate.
 *
 * Normalization:
 * - Trims string fields
 * - Defaults payload to {}
 ...
 */
export function createEvent(input: CreepEventCreate): EventValidationResult {
